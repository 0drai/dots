...
local remap_default = function(mode, key, f) remap(mode, key, f, default) end
...
-- toggle vista
remap_default('n', '<localleader>v', ':Vista!!<CR><C-W><C-P>')
...
telescope_remap('<leader>C',
                'find_files cwd=' .. os.getenv('XDG_CONFIG_HOME') .. 'nvim')
...
remap_default('n', '<c-n>', ':NvimTreeToggle<CR>')
